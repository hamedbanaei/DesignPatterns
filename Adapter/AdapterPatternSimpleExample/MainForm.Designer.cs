...
namespace AdapterPatternSimpleExample
{
	partial class MainForm
	{
		...
		{
			this.myFileListBoxAdapter = new AdapterPatternSimpleExample.FileListBoxAdapter();
			this.myFileListViewAdapter = new AdapterPatternSimpleExample.FileListViewAdapter();
			this.myFileTreeViewAdapter = new AdapterPatternSimpleExample.FileTreeViewAdapter();
