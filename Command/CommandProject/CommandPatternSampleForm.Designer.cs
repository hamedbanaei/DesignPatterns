namespace CommandProject
{
	partial class CommandPatternSampleForm
	{
		...
		{
			this.btnRedCommand = new CommandProject.CommandButton();
			this.myRedCommand = new CommandProject.Commands.RedCommand();
			this.btnKhakiCommand = new CommandProject.CommandButton();
			this.myKhakiCommand = new CommandProject.Commands.KhakiCommand();
			this.btnCyanCommand = new CommandProject.CommandButton();
			this.myCyanCommand = new CommandProject.Commands.CyanCommand();
			this.SuspendLayout();
			// 
			// btnRedCommand
			// 
